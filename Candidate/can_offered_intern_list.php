...
<?php
$session = session();
$active_sort_my_offers    =    $session->get('active_sort_my_offers');
// print_r($_SESSION);
...
<body class="stickyFoot">
    ...
    <section class="container filterable my-4">
        <div class="d-flex justify-content-between flex-wrap align-items-center mb-4">
            <h2 class="page_title mb-sm-0 mb-3">Direct Corporate Offers</h2>
        ...
        <div class="card p-4">
            <div class="d-flex justify-content-between flex-wrap">
                <ul class="nav nav-tabs hrInternList canAppList mb-4" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="<?= base_url(); ?>/direct-corporate-offers" class="nav-link active" id="intoff-tab"><img src='<?php echo base_url("/public/assets/img/internship_offers.svg"); ?>' width='18' class='me-2 mb-1'>Direct Corporate Offers
                ...
                <div class="col-md-4 col-lg-2 col-12 form-group mt-3 mb-2">
                    <!-- <label class="form-label" > Filter By : </label> -->
                    <select name="internship_duration" id="internship_duration" onchange="my_offer_list(this.value)" class="js-states selectSearch filterby form-control align-self-end">
                        <option value="1" <?php if (isset($active_sort_my_offers)) {
                                                if ($active_sort_my_offers == '1') {
                                                    echo 'selected';
                                                }
                                            } ?>>All</option>
                        <option value="2" <?php if (isset($active_sort_my_offers)) {
                                                if ($active_sort_my_offers == '2') {
                                                    echo 'selected';
                                                }
                                            } ?>>Offer accepted</option>
                        <option value="3" <?php if (isset($active_sort_my_offers)) {
                                                if ($active_sort_my_offers == '3') {
                                                    echo 'selected';
                                                }
                                            } ?>>Offer declined</option>
                        <option value="4" <?php if (isset($active_sort_my_offers)) {
                                                if ($active_sort_my_offers == '4') {
                                                    echo 'selected';
                                                }
                                            } ?>>Dropped</option>
                        <option value="5" <?php if (isset($active_sort_my_offers)) {
                                                if ($active_sort_my_offers == '5') {
                                                    echo 'selected';
                                                }
                                            } ?>>Completed</option>
                        <option value="7" <?php if (isset($active_sort_my_offers)) {
                                                if ($active_sort_my_offers == '7') {
                                                    echo 'selected';
                                                }
                                            } ?>>Hired</option>
                        <option value="9" <?php if (isset($active_sort_my_offers)) {
                                                if ($active_sort_my_offers == '9') {
                                                    echo 'selected';
                                                }
                                            } ?>>Ongoing</option>
                        <option value="10" <?php if (isset($active_sort_my_offers)) {
                                                if ($active_sort_my_offers == '10') {
                                                    echo 'selected';
                                                }
                                            } ?>>Offer expired</option>
                        <option value="11" <?php if (isset($active_sort_my_offers)) {
                                                if ($active_sort_my_offers == '11') {
                                                    echo 'selected';
                                                }
            ...
            <div class="pgContent">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="intoff" role="tabpanel" aria-labelledby="intoff-tab">
                            ...
                            <table class="table" id="example">
                                <thead>
                                    <tr class="filters">
                                        ...
                                        <th scope="col" class="text-center">Other Applicants</th>
                ...
                <img src="<?= base_url(); ?>/public/assets/img/menu_certificate.svg" alt="certificate" width="17" >
                                                            ...
                                                            <?php } else { ?>
                                                                <td class="text-center">
                                                                    ...
                                                                    ?>
                                                                                ...
                                                                                <a href="#" onclick="confirm_under_cons('<?php echo $internship_list->internship_id; ?>')"><button class="btn btn-orange f-13 py-1 px-2 mt-1" style="white-space: nowrap">Under Consideration</button></a>
                                            ...
                                            } elseif ($active_sort_my_offers == 7) {
                                                if ($current_date < $expire_date) {
        ...
        <img src="<?= base_url(); ?>/public/assets/img/menu_certificate.svg" alt="certificate" width="17" >
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            ?>
                                                                    ...
                                                                    ?>
                                                                        <a href="#" onclick="confirm_reject('<?php echo $internship_list->internship_id; ?>')"><button class="btn btn-danger f-13 py-1 px-2" style="white-space: nowrap;">Cancel Offer</button></a>
                                                                        <!-- <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Cancel offer" onclick="confirm_reject('<?php echo $internship_list->internship_id; ?>')">

                                                                                <img src="<?= base_url(); ?>/public/assets/img/cancel_offer_ico.svg" alt="report" width="18">
                                                                            </a> -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                <form method="post" action="<?php echo base_url('/complete-internship'); ?>">
                    ...
                    <input type="hidden" name="page_redirect" id="page_redirect" value="2">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-content">
                <form method="post" action="<?php echo base_url('/Reject-Hiring'); ?>">
                    ...
                    <input type="hidden" name="redirect_url" id="redirect_url" value="2">
                    <input type="hidden" class="csrf" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                    <div class="modal-header justify-content-center border-bottom-0 pt-4">
    ...
    <script>
        ...
        function my_offer_list(val) {
            // alert(val);
            // $('#internship_duration').val();
            window.location.href = "<?= base_url(); ?>/direct-corporate-offers/" + val;
        }
