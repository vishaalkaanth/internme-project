...
<?php
$session = session();
$active_sort_my_intern    =    $session->get('active_sort_my_intern');
// print_r($_SESSION);
...
<body class="stickyFoot">
    ...
    <section class="container filterable my-4">
        <div class="d-flex justify-content-between flex-wrap align-items-center mb-4">
            <h2 class="page_title mb-sm-0 mb-3">My Internships</h2>
        ...
        <div class="card p-4">
            <div class="d-flex justify-content-between flex-wrap">
                <ul class="nav nav-tabs hrInternList canAppList mb-4" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a href="<?= base_url(); ?>/my-applications" class="nav-link " id="myapp-tab"><img src='<?php echo base_url("/public/assets/img/my_application.svg"); ?>' width='15' class='me-2 mb-1'>My Applications
                            <span class="badge bg-gray1 ms-2 p-1 fw-normal"><?php if (isset($application_count_applied_internship_list) && !empty($application_count_applied_internship_list)) {
                                                                                echo count($application_count_applied_internship_list);
                                                                            } else {
                                                                                echo '0';
                                                                            } ?></span>
                        </a>
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="<?= base_url(); ?>/direct-corporate-offers" class="nav-link " id="intoff-tab"><img src='<?php echo base_url("/public/assets/img/internship_offers.svg"); ?>' width='18' class='me-2 mb-1'>Direct Corporate Offers
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="<?= base_url(); ?>/my-internships" class="nav-link active" id="myint-tab"><img src='<?php echo base_url("/public/assets/img/icon_intern1.svg"); ?>' width='17' class='me-2 mb-1'>My Internships
                ...
                <div class="col-md-4 col-lg-2 col-12 form-group mt-3">
                    ...
                    <select class="js-states selectSearch filterby form-control align-self-end" name="internship_duration" id="internship_duration" onchange="my_internship_list(this.value)">
                        <!-- <select name="internship_duration" id="internship_duration" onchange="my_internship_list(this.value)" class="js-states form-control filledBox border-0 f-14"> -->
                        <option value="1" <?php if (isset($active_sort_my_intern)) {
                                                if ($active_sort_my_intern == '1') {
                                                    echo 'selected';
                                                }
                                            } ?>>All</option>
                        <option value="5" <?php if (isset($active_sort_my_intern)) {
                                                if ($active_sort_my_intern == '5') {
                                                    echo 'selected';
                                                }
                                            } ?>>Completed</option>
                        <option value="7" <?php if (isset($active_sort_my_intern)) {
                                                if ($active_sort_my_intern == '7') {
                                                    echo 'selected';
                                                }
                                            } ?>>Offer accepted</option>
                        <option value="9" <?php if (isset($active_sort_my_intern)) {
                                                if ($active_sort_my_intern == '9') {
                                                    echo 'selected';
                                                }
                                            } ?>>Ongoing</option>
                        <option value="4" <?php if (isset($active_sort_my_intern)) {
                                                if ($active_sort_my_intern == '4') {
                                                    echo 'selected';
                                                }
                                            } ?>>Dropped</option>
            ...
            <div class="pgContent mt-2">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="intoff" role="tabpanel" aria-labelledby="myint-tab">
                            ...
                            <table class="table" id="example">
                                <thead>
                                    <tr class="filters">
                                        ...
                                        <th scope="col">POC Details</th>
                                        <!-- <th scope="col" class="text-center">POC Email ID</th> -->
                                ...
                                <tbody>
                                    <?php if (isset($applied_internship_list) && !empty($applied_internship_list)) {
                                        ...
                                        foreach ($applied_internship_list as $internship_list) {
                                            ...
                                            if (!empty($internship_list->emp_supervisor)) {
                                                $where_super = array('userid' => $internship_list->emp_supervisor);
                                                $super_det = $Candidate_model->fetch_table_row('userlogin', $where_super);
                                            } else {
                                                $where_super = array('userid' => $internship_details->assigned_to);
                                                $super_det = $Candidate_model->fetch_table_row('userlogin', $where_super);
                                            }
                                            //if($internship_list->complete_type==1)
                                            // if($internship_details->internship_startdate < $today_date){
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php if (isset($super_det->name)) {
                                                        echo $super_det->name;
                                                    } ?>
                                                    <?php if (isset($super_det->email)) {
                                                        echo '(' . $super_det->email . ')';
                                                    } ?></td>
                                    ...
                                    <a href="<?php //echo base_url('can-apply-for-internship'); 
                                                ...
                                                ?>
                                                                ...
                                                                if ($internship_list->complete_type != 1) {
                                                                    ...
                                                                    <?php if ($internship_list->certificate_issue_status == 1) { ?>
                                                                        ...
                                                                        <a href="<?= base_url(); ?>/candidate-certificate/<?php echo $internship_list->internship_id; ?>" data-bs-toggle="tooltip" title="View Certificate" class="">
                                                                            ...
                                                                            <img src="<?= base_url(); ?>/public/assets/img/menu_certificate.svg" alt="report" width="18">
                                                                        </a>
                                                                    <?php } ?>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        ?>
                                                                <a href="#" onclick="confirm_accept('<?php echo $internship_list->internship_id; ?>')"><button class="btn btn-green f-13 py-1 px-2">Accept Offer</button></a>
                                                            <?php
                                                            }
                                                            if ($internship_list->hiring_status == 1) {
                                                            ?>
                                                                <a href="#" onclick="confirm_reject('<?php echo $internship_list->internship_id; ?>')"><button class="btn btn-danger f-13 py-1 px-2" style="white-space: nowrap;">Cancel Offer</button></a>
                                                        <?php
                                                            }
                                                        }
                                                        ?>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-content">
                <form method="post" action="<?php echo base_url('/Reject-Hiring'); ?>">
                    ...
                    <input type="hidden" name="redirect_url" id="redirect_url" value="3">
    ...
    <!-- Modal cancel -->
    <!-- <div class="modal fade" id="complete_popup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">

            <div class="modal-content">
                <form method="post" action="<?php echo base_url('/complete-internship'); ?>">
                    <input type="hidden" name="complete_id" id="complete_id">
                    <input type="hidden" name="complete_type" id="complete_type" value="1">
                    <input type="hidden" name="page_redirect" id="page_redirect" value="3">
                    <input type="hidden" class="csrf" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                    <div class="modal-header justify-content-center border-bottom-0 pt-4">
                        <h5 class="modal-title text-green fw-semibold" id="exampleModalLabel">Complete Reason</h5>
                    </div>
                    <div class="modal-body pb-0 px-4">
                        <div class="col-12 form-group selectField mb-4">
                            <label for="" class="form-label">Enter Reason <span style="color:#dd4b39;">*</span></label>
                            <textarea maxlength="500" id="complete_reason" name="complete_reason" class="form-control filledBox border-0 py-2 f-14" placeholder="Reason for Complete Internship (max 500 char)" style="height: 100px;"></textarea>
                            <span id='remainingC1'></span>
                            <font style="color:#dd4b39;">
                                <div id="complete_reason_alert"></div>
                            </font>
                    ...
                    <div class="modal-footer border-top-0 justify-content-between pt-0 pb-4 px-4">
                        <button type="button" class="btn btn-outlined-blue" data-bs-dismiss="modal">Cancel</button>
                        <input type="submit" class="btn btn-prim float-end" id="complete_submit" value="Submit" />
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="facultyconfirm" tabindex="-1" aria-labelledby="facultyconfirmLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form action="<?= base_url(); ?>/Accept-Hiring" method="post" accept-charset="utf-8" class="" id="add_emp_manage_admin" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header justify-content-center border-bottom-0 pt-4">
                        <h5 class="modal-title text-green fw-semibold text-center" id="exampleModalLabel">Do you want to showcase this Internship <br>to your College for Academic credits</h5>
                    </div>
                    <div class="modal-body pb-0 px-4">
                            ...
                            <div id="faculty_data" style="display:none">
                                ...
                                <div class="col-md-12 form-group selectField">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <input type="text" maxlength="20" name="can_reg_number" id="can_reg_number" class="form-control filledBox border-0 py-2 ps-0 f-14" placeholder="Enter Registration No">
                                    </div>
                                    <font style="color:#dd4b39;">
                                ...
                                <div class="col-md-12 form-group selectField">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <input type="email" maxlength="50" autocomplete="off" name="faculty_email" id="faculty_email" class="form-control filledBox border-0 py-2 ps-0 f-14 email" placeholder="Enter Email ID" onkeyup="profile_email()">
    ...
    <script>
                ...
                success: function(resp) {
                    ...
                    if (resp.result == 0) {
                        swal({
                            ...
                            function() {
                                window.location.href = "<?php echo base_url('/Accept-Hiring'); ?>/3/" + id;
        ...
        function my_internship_list(val) {
            window.location.href = "<?= base_url(); ?>/my-internships/" + val;
        }
        // $(".filterby").select2({
        ...
        $(document).ready(function() {
            ...
            $("#can_reg_number").keyup(function() {
                return validatetext_all_spcl_char_style('can_reg_number', 'can_reg_number_alert', 'Your Registration Number');
            });
        ...
        $(document).ready(function() {
            $("#faculty_submit").click(function() {
                ...
                if (faculty == 1) {
                    var can_reg_number = validatetext_all_spcl_char_style('can_reg_number', 'can_reg_number_alert', 'Your Registration Number');
